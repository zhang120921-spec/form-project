...
describe("handicapIndex — large histories", () => {
  for (const n of [3, 19, 20, 21, 999, 1000, 10_000]) {
    it(`finite at ${n} differentials`, () => {
  ...
  it("handicapIndex < 3 returns null", () => {
...
describe("rdFor — negative idle days", () => {
  it("negative idle days yields finite deviation", () => {
  ...
  it("very negative idle days yields finite deviation", () => {
...
describe("stablefordToAGS — bad par", () => {
  it("non-finite par throws", () => {
...
describe("validateRound — NaN participants", () => {
  it("NaN AGS rejected", () => {
  ...
  it("AGS out of range rejected (below 18)", () => {
    const result = validateRound({
      date: "2026-08-01",
      format: "stroke",
      course: "Sentosa",
  ...
  it("AGS out of range rejected (above 200)", () => {
    const result = validateRound({
      date: "2026-08-01",
      format: "stroke",
      course: "Sentosa",
  ...
  it("duplicate participants rejected", () => {
    const result = validateRound({
      date: "2026-08-01",
      format: "stroke",
      course: "Sentosa",
  ...
  it("future-dated round rejected", () => {
  ...
  it("non-numeric string rejected as AGS", () => {
    const result = validateRound({
      date: "2026-08-01",
      format: "stroke",
      course: "Sentosa",
  ...
  it("numeric string accepted as AGS (parse explicitly)", () => {
    const result = validateRound({
      date: "2026-08-01",
      format: "stroke",
      course: "Sentosa",
  ...
  it("valid round passes validation", () => {
    const result = validateRound({
      date: "2026-08-01",
      format: "stroke",
      course: "Sentosa",
  ...
  it("stableford negative points rejected", () => {
    const result = validateRound({
      date: "2026-08-01",
      format: "stableford",
      course: "Sentosa",
  ...
  it("match margin exceeding holes rejected", () => {
    const result = validateRound({
      date: "2026-08-01",
      format: "match",
      course: "Sentosa",
...
describe("replay quarantine", () => {
  it("quarantined round does not affect other player ratings", () => {
  ...
  it("replay quarantine list is returned", () => {
    const result = replay(
...
describe("pool conservation", () => {
  it("pool conservation over mixed ratings", () => {
    const players: Player[] = [
...
describe("empty rosters", () => {
  it("replay with 0 players and 0 rounds returns empty", () => {
  ...
  it("replay with 1 player and 0 rounds returns seeded rating", () => {
    const result = replay(
  ...
  it("computeRound with 1 entry throws", () => {
    assert.throws(
      () => {
        computeRound(
...
describe("seeding monotonicity", () => {
  it("seedRating strictly decreasing across WHS range", () => {
  ...
  it("seedRating always positive (>= floor)", () => {
  ...
  it("seedRating C¹ continuous at h=30", () => {
    const h = 1e-6;
...
describe("stableford identity", () => {
  it("stablefordToAGS / AGS roundtrip is consistent", () => {
...
describe("nine-hole reduction", () => {
  it("alphaForHoles 18 → base alpha (no scaling)", () => {
    assert.strictEqual(alphaForHoles(0.3, 18), 0.3);
  });

  it("kScaleForHoles 18 → 1 (no scaling)", () => {
    assert.strictEqual(kScaleForHoles(18), 1);
  });

  it("nine-hole alpha > 18-hole alpha", () => {
