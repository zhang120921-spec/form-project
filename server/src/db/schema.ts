...
export function runMigrations() {
  ...
  if (!resetColNames.has("token_plain")) {
    db.exec("ALTER TABLE password_resets ADD COLUMN token_plain TEXT");
    console.log("Added token_plain column to password_resets");
  }
